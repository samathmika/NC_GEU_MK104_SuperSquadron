...
public class NotificationHelper<button> extends ContextWrapper {
    ...
    public void sendHighPriorityNotification(String title, String body, Class activityName) {
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText("Reaching late?\nIs the road filled with Traffic??")
    ...
    public void sendPriorityNotification(String title, String body, Class<MapsActivity> activityName) {
        for(speed=0;speed<20;speed++) {
            if (speed == 10) {
                ...
                Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                        .setContentTitle("Traffic")
                        .setContentText("Overspeeding is fun right!\nAny idea about the consequences?")
                        .setSmallIcon(R.drawable.ic_launcher_background)
                        .setPriority(NotificationCompat.PRIORITY_HIGH)
                        .setStyle(new NotificationCompat.BigTextStyle().setSummaryText("summary").setBigContentTitle(title).bigText(body))
                        .setContentIntent(pendingIntent)
